...
public class ThrowingRockDamage : MonoBehaviour 
{
...
//				Debug.Log ("notnull2");
		...
		else if (other.collider.tag == "Mask")
		{		
			TalkingHeadLife headLift = other.gameObject.GetComponent<TalkingHeadLife> ();
			if(headLift != null)
			{	
				headLift.TakeDamage (attackDamage * 2);
			}
		}	
